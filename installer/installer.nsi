...
; ---- General ----
Name "WINQ-EMU Alpha 2"
OutFile "..\WINQ-EMU-Alpha2-Setup.exe"
...
VIAddVersionKey "FileDescription" "WINQ-EMU Alpha 2 - Optimized QEMU for Windows"
...
!define MUI_WELCOMEPAGE_TITLE "Welcome to WINQ-EMU Alpha 2"
...
This will install WINQ-EMU Alpha 2 on your computer.$\r$\n$\r$\n\
...
; ---- Descriptions ----
LangString DESC_SecCore ${LANG_ENGLISH} "QEMU with enhanced WHPX host CPU passthrough, Venus Vulkan GPU acceleration, and all required libraries."
